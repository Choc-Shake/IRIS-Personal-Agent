...
3. The web search tool to find top news headlines today that SPECIFICALLY relate to the user's interests found in memory.
...
- Summarize the personalized news in a sentence or two.
